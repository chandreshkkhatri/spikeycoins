          ...
          {!hasAccount ? (
            ...
            <div className="text-center py-12 px-6">
              <div className="max-w-sm mx-auto">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Please select a trading account to view your portfolio
                  holdings
                </p>
            ...
            <div className="text-center py-12 px-6">
              <div className="max-w-sm mx-auto">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  You don&apos;t have any stocks or securities in your portfolio
                  yet
                </p>
                ...
                <div className="text-xs text-muted-foreground/70 mt-3">
                  Your holdings will appear here once you make your first
                  purchase
                </div>
              </div>
            </div>
